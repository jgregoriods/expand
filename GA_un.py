...
class Gen_01:
    def initialize(self): 
        self.value = int(np.random.uniform(20, 250, 1)[0])
    def mutation(self):
...
class Gen_02:
    def initialize(self): 
        self.value = int(np.random.uniform(30, 300, 1)[0])
    def mutation(self):
...
class Gen_04:
    def initialize(self): 
        if 0.5 > np.random.uniform(0, 1, 1)[0]: # 50% prob to set 0
            ...
            self.value = int(np.random.uniform(15, 50, 1)[0])
    def mutation(self):
...
class Gen_06:
    ...
    def mutation(self):
        ...
        self.value = np.where(aux < -10 or aux > 10, self.value, aux)
...
class Genome: 
    ...
    def initialize(self): 
        self.genes = [Gen_01(), Gen_02(), Gen_03(), Gen_04(), Gen_05(),
                      Gen_06(), Gen_06(), Gen_06(), Gen_06(), Gen_06()]
        for i in self.genes:
            i.initialize()
    ...
    def Print(self): 
        print('\nFitness: %s\n' % self.fitness)
        print(np.array(self.genes_values()))
...
def main():
    my_ga = GA(100, 4, 1, 0.8, 0.2, 101)                                                              # parameters
    my_ga.initialize()
    my_ga.evolve()
